...
def main():
    file_path = r'E:\University\Year 3 - 3\DA3\ai_pipeline\data\raw\DSLIB\Excel\C2012-08 Sea Electricity.xlsx'
    ...
    for i in range(1, len(df_schedule)):
        ...
        if classification == 'G1_Purchasing':
            g1['chi_phi_vat_lieu'] += fixed_cost + var_cost
        elif classification == 'G6_Transport_Logistics':
            g6['chi_phi_van_tai_qt'] += fixed_cost * 0.8 + var_cost * 0.5
            g6['chi_phi_luu_kho'] += fixed_cost * 0.2 + var_cost * 0.5
        elif classification == 'G6_Handling_Earthworks':
            g6['chi_phi_boc_xep'] += fixed_cost * 0.7 + var_cost
            g1['chi_phi_nhien_lieu'] += fixed_cost * 0.3
        elif classification == 'G1_Manufacturing':
            g1['chi_phi_vat_lieu'] += fixed_cost * 0.6 + var_cost * 0.5
            g1['chi_phi_thue_ngoai'] += fixed_cost * 0.4 + var_cost * 0.5
        elif classification == 'G2_Setup_Utility':
    ...
    out_dir = r'E:\University\Year 3 - 3\DA3\ai_pipeline\data\processed\C2012-08'
    ...
    for t in output_tasks:
        row = {
            ...
            "g7_dur_hours": t["g7_temporal"]["total_hours"],
